...
from app.config import (
    ...
    LIMIT_PRO_LEARNING_TOPICS,
    LIMIT_STARTER_COLLECTIONS,
    LIMIT_STARTER_CONVERSATIONS,
    LIMIT_STARTER_LEARNING_TOPICS,
)
...
PRO_LEARNING_TOPIC_LIMIT = LIMIT_PRO_LEARNING_TOPICS
STARTER_LEARNING_TOPIC_LIMIT = LIMIT_STARTER_LEARNING_TOPICS
