export function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4 text-center px-6 select-none">
      ...
      <div>
        <h2 className="text-lg font-semibold text-gray-200">Start a conversation</h2>
      ...
      <div className="flex flex-wrap justify-center gap-2 mt-2">
        {[
          ...
          <span
            key={suggestion}
            className="px-3 py-1.5 text-xs bg-gray-800 text-gray-400 rounded-full border border-gray-700"
          >
            {suggestion}
          </span>
        ))}
